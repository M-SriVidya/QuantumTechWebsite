    ...
    return (
        <div>
            ...
            <div class="bg-[url('https://media.discordapp.net/attachments/1025099364584149094/1133843402098741484/image.png')] p-12">
                ...
                <p class="text-xl text-white ml-6"> Kaṇāda was an ancient Indian natural scientist and philosopher known for founding the Vaisheshika school of Indian philosophy, which is considered the earliest Indian physics. He made pioneering contributions by developing an atomistic approach to both physics and philosophy. In his Sanskrit text, Vaiśeṣika Sūtra, he proposed the concept of the paramanu, an indestructible and indivisible particle of matter that cannot be further divided. Kaṇāda used invariance arguments to deduce properties of these atoms and suggested that they could exist in two states: absolute rest and a state of motion. His work has had a profound impact on ancient Indian philosophical discussions and laid the groundwork for understanding the fundamental nature of matter and reality.</p>
                ...
                <p class="text-xl text-white ml-6 mb-2"> The QuaNaD is Quantum Technology Group; a specific team is dedicated to technology using quantum principles. The realm of materials science and quantum physics has seen remarkable advancements in recent years. This article delves into the fascinating world of electrical and optical properties, with a focus on quantum dots, quantum computing, conducting glasses, and the modeling and characterization of battery materials. These areas of research hold immense promise and are poised to revolutionize various industries and represent the cutting edge of scientific and technological innovation </p>
